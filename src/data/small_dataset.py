...
if __name__ == '__main__':
    ...
    for position, name in enumerate(['X_train_small.pickle', 'X_val_small.pickle', 'X_test_small.pickle']):
        with open(name, 'wb') as f:
            pickle.dump(data[position][0], f)

    for position, name in enumerate(['y_train_small.pickle', 'y_val_small.pickle', 'y_test_small.pickle']):
        with open(name, 'wb') as f:
