...
from keras.layers import MaxPooling2D, Conv2D, Flatten, Dense, Dropout, GlobalMaxPooling2D
...
if __name__ == '__main__':
    ...
    model.add(Conv2D(64, (3, 3), activation='relu'))
    model.add(GlobalMaxPooling2D(name='gmp'))
    model.add(Flatten())
    ...
    model.save('3_shallow_cnn_gmp.h5', save_format='h5')
